  ...
  return `<!DOCTYPE html>
    ...
    <div class="header">
     <img id="logo" src="https://res.cloudinary.com/dgn6edv1k/image/upload/v1740314841/Artboard_2_ybpuuq.png" width="50" height="50"/>
        <h1>Invite to ${companyName}!</h1>
    </div>
    <div class="content">
        <p>Hello, </p>
        <p>We trust this email finds you well. You have been invited by ${invitedBy} as a ${role} at ${companyName}</p>

        <p>
        Please click on the button below to verify your account and access your ${companyName} account.
        </p>

        <a href="${process.env.CLIENT_URL}/admin/register?user=${id}" class="button">Verify Your Account</a>
